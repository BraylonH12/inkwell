...
We need an architecture that is easy to build and maintain. It should support gradual development throughout the course. 
...
- Their scalability benefits are not needed for a project ofthis size.
...
n to followers. This would not change the overall architecture.
##### Consequences
**Positive**
